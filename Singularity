...
%post
    ...
    /sw/apps/R/x86_64/4.0.0/rackham/bin/R -e "install.packages(c('BiocManager','remotes','dplyr','pheatmap','stringr','tidyr','ggplot2'), dependencies=TRUE, repos='http://cran.rstudio.com/', Ncpus=8)"
    /sw/apps/R/x86_64/4.0.0/rackham/bin/R -e "BiocManager::install(c('DESeq2','edgeR','goseq','GO.db','org.Mm.eg.db','reactome.db'))"
